...
public class Walkin_Page1 extends TestBase{
	...
	public void PlaceWalkinOrder(String cus,String pname,int qua,int returnindays,String mode,String adv,String modeofpayment){
		try {
			...
			SelectPaymentInWalkin(mode,modeofpayment,adv);
	...
	public void PlaceWalkinOrderAndVerifyErrorMessage(String cus,String pname,int qua,int returnindays){
		try {
	...
	public void SelectProductInWalkin(String pname,int qua,int returnindays,String mode){
		try {
			...
			String getdepositamt=driver.findElement(By.xpath("//input[@name='Deposit']")).getAttribute("value");
			System.out.println("getdepositamt "+getdepositamt);
			if(Integer.parseInt(getdepositamt)==0){
				driver.findElement(By.xpath("//input[@name='Deposit']")).clear();
				driver.findElement(By.xpath("//input[@name='Deposit']")).sendKeys("600");
	...
	public void SelectPaymentInWalkin(String prevoiusmode,String modeofpayment,String adv){
		try {
			...
			if(flag && !prevoiusmode.equals("Deposit")){
				...
				int payable=CalculatePayableAmountHavingAdvance(getActualAdvAmt,prevoiusmode);
			...
			}else if(flag && prevoiusmode.equals("Deposit")){
				...
				//Calculate Payable Amount
				int payable=CalculatePayableAmount(prevoiusmode);
				System.out.println("Payable "+payable);
	...
	public int CalculatePayableAmount(String previousmode){
		int payable;
		if(!previousmode.equals("Deposit")){
			String getCurrentBillAmt=driver.findElement(By.xpath("//label[text()='Current Bill Amount:']/ancestor::div[2]//div[2]//label")).getText();
			String getPayableAmt=driver.findElement(By.xpath("//label[text()='Payable Amount:']/ancestor::div[2]//div[2]//label")).getText();
			
			payable=Integer.parseInt(getPayableAmt);
	...
	public int CalculatePayableAmountHavingAdvance(String adv,String previousmode){
		int payable;
		if(!previousmode.equals("Deposit")){
			String getCurrentBillAmt=driver.findElement(By.xpath("//label[text()='Current Bill Amount:']/ancestor::div[2]//div[2]//label")).getText();
			String getPayableAmt=driver.findElement(By.xpath("//label[text()='Payable Amount:']/ancestor::div[2]//div[2]//label")).getText();
